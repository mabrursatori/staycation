...
import CitiesIcon from 'assets/images/icons/cities_icon.svg'
import TravelersIcon from 'assets/images/icons/travelers_icon.svg'
import TreasureIcon from 'assets/images/icons/treasure_icon.svg'
            ...
            <div className="row align-items-center">
                <div className="col-auto pr-5" style={{width: 530}}>
                    ...
                    <div className="row" style={{marginTop: 80}}>
                        <div className="col-auto" style={{marginRight: 35}}>
                            <img width="36" height="36" src={TravelersIcon} alt={`${props.data.travelers} Travelers`}/>
                            <h6 className="mt-3">
                ...
                <div className="col-6 pl-5">
                    <div style={{width: 520, height: 410}}>
                        ...
                        <img src={FrameHero} alt="Room with couches" className="img-fluid position-absolute" style={{margin: "0 -15px -15px 0"}}/>
                    </div>
                </div>
            </div>
        </section>
